...
CHARACTERISTICS_BOOK = {"height": 15, "width": 10, "depth": 2, "weight": 1000}
CHARACTERISTICS_PFF2_MASK = {"height": 10, "width": 10, "depth": 0.01, "weight": 50}
...
CHEAP_FEE = {"height": 10, "width": 10, "depth": 5, "weight": 500}
...
@pytest.mark.parametrize("product, expected_fee", one_product)
